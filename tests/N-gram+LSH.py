...
def generate_ngram_lsh_fingerprint(text, n=3, num_perm=128, threshold=0.5):
    """
...
if __name__ == '__main__':
    ...
    # str3 = '0.813762178'
    # 生成示例文本的N-gram + LSH文件指纹
    fingerprint1 = generate_ngram_lsh_fingerprint(str1)
    fingerprint2 = generate_ngram_lsh_fingerprint(str2)
    fingerprint3 = generate_ngram_lsh_fingerprint(str3)

    print("N-gram + LSH文件指纹示例:")
    ...
    # 计算相似度
    similarity1 = calculate_similarity(fingerprint1, fingerprint2)
    similarity2 = calculate_similarity(fingerprint1, fingerprint3)
    similarity3 = calculate_similarity(fingerprint2, fingerprint3)
    print("1和2两个文本的相似度为:", similarity1)
    print("1和3两个文本的相似度为:", similarity2)
    print("2和3两个文本的相似度为:", similarity3)