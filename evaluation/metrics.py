...
def compute_metrics(ranked_judgements, pr_atks, threshold_grade):
    ...
    :return: metrics: dict; the computed metrics.
    """
    metrics = {}
    ...
    metrics['av_precision'] = float(av_precision) # average precision(also called MAP since the ranked_judgements is a 1D array)l
